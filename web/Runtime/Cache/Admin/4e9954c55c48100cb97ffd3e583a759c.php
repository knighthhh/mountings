...
<body>
<form method="post" action="/mountings/web/index.php/Admin/Car/get_item/p/ADMIN_LAYUI_URLlay/dest/layui.all.js" id="listform">
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      <tr>
        ...
        <th width="15%" style="">m3id</th>
        <th width="15%" style="">partid</th>
        <th width="15%" style="">img</th>
        <th width="15%" style="">item_OE</th>
        <th width="15%" style="">item_arg</th>
      </tr>
      <?php if(empty($data)): ?>
      		<tr>
      			<td></td>
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <td><?php echo $v['item_m3id']; ?></td>
          <td><?php echo $v['item_partid']; ?></td>
          <td> <img src="<?php echo $v['item_img']; ?>"/> </td>
          <td><?php echo $v['item_oe']; ?></td>
          <td><?php echo $v['item_arg1']; ?></td>
        </tr>
