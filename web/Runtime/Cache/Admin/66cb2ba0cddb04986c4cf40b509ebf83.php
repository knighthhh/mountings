...
<body>
<form method="post" action="/index.php/Admin/Contact/get_text" id="listform">
  <div class="panel admin-panel">
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <td><?php echo $v['con_name']; ?></td>
          <td><?php echo $v['con_email']; ?></td>
          <td><?php echo $v['con_text']; ?></td>
