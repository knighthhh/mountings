...
<body>
	...
	<div id="contact">
		...
		<div class="container">
			<div class="" style="padding-top: 50px;text-align: center;padding-left: 25%;padding-right: 25%;font-family:  Arial Rounded MT Bold;">
			  <form class="form-horizontal" >
				  
				  <div class="form-group">
				    <label for="lastname" class="col-sm-2 control-label"><?php echo ($contact['name']); ?></label>
				    <div class="col-sm-10">
				      <input type="text" class="form-control" id="" name="name" placeholder="">
				    </div>
				  </div>
				  <div class="form-group">
				    <label for="lastname" class="col-sm-2 control-label"><?php echo ($contact['email']); ?></label>
				    <div class="col-sm-10">
				      <input type="text" class="form-control" id="" name="email" placeholder="">
				    </div>
				  </div>
				  <div class="form-group">
				    <label for="lastname" class="col-sm-2 control-label"><?php echo ($contact['content']); ?></label>
				    <div class="col-sm-10">
				  ...
				  <div class="form-group ">
				    <div class="col-sm-offset-2 col-sm-10">
				      <button type="" class="submit btn btn-default pull-right"><?php echo ($contact['submit']); ?></button>
				    </div>
				  </div>
				</form>
...
<script src="<?php echo (HOME_JS_URL); ?>/bootstrap.min.js"></script>
	...
	<script type="text/javascript">
		...
		$('.submit').on('click',function(){
			...
			url = "/index.php/Home/Contact/save_info";
			$.ajax({  
                type:'post',  
                url:url,
                data:{
