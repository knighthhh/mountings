	...
	<div id="solutionbody">
		...
		<div class="tab-pro">
			<div class="">
				...
				<p class="tab-pro-p mytext-align"><?php echo ($solutions['tab2_box2_p1']); ?> <?php echo ($solutions['tab2_box2_p2']); echo ($solutions['tab2_box2_p3']); echo ($solutions['tab2_box2_p4']); ?></p>
				...
				<div class="tab-pro-hidden mytext-align">
					...
					<p class="tab-pro-pb"><?php echo ($solutions['tab2_box2_p1']); ?> <?php echo ($solutions['tab2_box2_p2']); echo ($solutions['tab2_box2_p3']); echo ($solutions['tab2_box2_p4']); ?><span class="tab-pro-btn2"><a> ∧</a></span></p>
				</div>
			</div>
		</div>	
		...
		<div id="tab1">
			...
			<div class="">
				<div class="tab1-box1 " >
					...
					<div class="mytext-align mytext-body"><?php echo ($solutions['tab3_p1']); ?> <?php echo ($solutions['tab3_p2']); ?></div> 
					<p ></p>
				</div>
				<div class="container">
		...
		<div id="tab2" style="">
			...
			<div class="">
				<div class="tab2-box1">
					...
					<div class="mytext-align mytext-body"><?php echo ($solutions['tab4_p1']); ?> <?php echo ($solutions['tab4_p2']); echo ($solutions['tab4_p3']); ?></div> 
